...
export default function UnsafeContent() {
  ...
  useEffect(() => {
    if (shadowRef.current && content) {
      ...
      let dangerous_content: string = content ? (content as string) : "";
